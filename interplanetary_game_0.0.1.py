...
zonemap = {
    ...
    'c2': {
        ...
        DESCRIPTION: 'Upon analysis of data from your scanners, high levels of ferrous metals have been detected',
        EXAMINATION: 'examine',
        SOLVED: False,
        UP: 'b2',
        DOWN: 'd2',
    ...
    'c3': {
        ...
        EXAMINATION: 'This system seems to undergo very little change over time, or at least none since you last observed it.',
        SOLVED: False,
        UP: 'b3',
        DOWN: 'd3',
        LEFT: 'c2',
...
def prompt():
    ...
    action = input("> ")
    acceptable_actions = ['quit', 'exit', 'move', 'go', 'travel', 'quit', 'examine', 'inspect', 'interact', 'look']
...
def player_examine(action):
    if zonemap[myPlayer.location][SOLVED]:
        print("You have already solved this sector.")
    else:
